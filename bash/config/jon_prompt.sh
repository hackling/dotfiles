...
export PS1='\[\e[36m\]\w\[\e[0m\] $(__git_ps1 "\[\e[37m\](\[\e[0m\]")$(__git_dirty "\[\e[35m✗$(tput sc)\]   \[$(tput rc)\e[0m\]")$(__git_clean "\[\e[32m✓$(tput sc)\]   \[$(tput rc)\e[0m\]")$(__git_ps1 " \[\e[34m\]%s\[\e[0;37m\])\[\e[0m\] ")\[\e[33m\]\$\[\e[0m\] '
